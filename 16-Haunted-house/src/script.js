...
const wallNormalTexture = textureLoader.load('./wall/castle_brick_broken_06_1k/castle_brick_broken_06_nor_1k.webp')
...
const roofNormalTexture = textureLoader.load('./roof/roof_slates_02_1k/roof_slates_02_nor_1k.webp')
...
const bushNormalTexture = textureLoader.load('./bush/leaves_forest_ground_1k/leaves_forest_ground_nor_1k.webp')
...
const graveNormalTexture = textureLoader.load('./grave/plastered_stone_wall_1k/plastered_stone_wall_nor_1k.webp')
...
const floor =  new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        displacementScale: 0.3, // changes scale of change
...
door.position.y = 1
door.position.z = 2 + 0.01 // to prevent z-fighting
house.add(door)
...
// const pointLightCameraHelper = new THREE.PointLightHelper(doorLight, 0.2)
// pointLightCameraHelper.visible = true
// house.add(pointLightCameraHelper)
